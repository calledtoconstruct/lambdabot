...
module Lambdabot.Plugin.Misc.Dummy
  ( dummyPlugin
  )
where
...
import           Lambdabot.Plugin.Misc.Dummy.DocAssocs
                                                ( docAssocs )
...
dummyPlugin = newModule
  ...
  , contextual = \msg -> case msg of
                   "lisppaste2: url" ->
                     say "Haskell pastebin: http://lpaste.net/"
                   _ -> return ()
  }
