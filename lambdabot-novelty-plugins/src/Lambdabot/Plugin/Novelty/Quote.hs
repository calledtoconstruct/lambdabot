...
import Data.Fortune (FortuneType (All), randomFortune, resolveFortuneFiles)
import Data.List (delete, isInfixOf)
import qualified Data.Map as M (Map, assocs, delete, empty, filter, insert, lookup, null, toList)
